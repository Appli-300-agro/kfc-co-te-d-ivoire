          ...
          <div className="space-y-6">
            <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-secondary">+237 272 15 49 20</p>
            ...
            <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-sm flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-secondary">contact@kfccotedivoire.cm</p>
                <p className="text-sm text-secondary">support@kfccotedivoire.cm</p>
              </div>
            </div>
