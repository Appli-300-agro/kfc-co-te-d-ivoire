# KFC Côte d'Ivoire - Plateforme Web E-commerce

Bienvenue sur le dépôt du code source de l'application web **KFC Côte d'Ivoire**. Ce projet est une solution complète (Site Vitrine + E-commerce + Administration) développée avec des technologies modernes pour assurer performance et évolutivité.
...
| :--- | :--- | :--- | :--- |
| **Administrateur** | `admin@kfccotedivoire.cm` | `admin123` | **OTP : 2025** |
| **Utilisateur** | `user@kfccotedivoire.cm` | `user123` | |
...
*   **Contact :** contact@kfccotedivoire.cm